    ...
    return <div>
        <div className="quiz__body sm-s">
            ...
            <div className="rules sm-s">
                <ul>
                    {attemptedQuiz.questions.map((element: any, index: Number) => {
                        return <li className="stack" key={element}>
                            ...
                            <ul className="stack">
                                <li className="question">
                                    <span
                                        ...
                                        ${attemptedQuiz.answers[Number(index)] === 'one' ? 'right__label' : ''}
                                        ${attemptedQuiz.attempts[Number(index)] !== attemptedQuiz.answers[Number(index)]
                                                && attemptedQuiz.attempts[Number(index)] === 'one' ? 'wrong__label' : ''}`}>
                                ...
                                <li className="question">
                                    <span
                                        className={`options_label 
                                        ${attemptedQuiz.answers[Number(index)] === 'two' ? 'right__label' : ''}
                                        ${attemptedQuiz.attempts[Number(index)] !== attemptedQuiz.answers[Number(index)]
                                                && attemptedQuiz.attempts[Number(index)] === 'two' ? 'wrong__label' : ''}`}>
                                ...
                                <li className="question">
                                    <span
                                        className={`options_label 
                                        ${attemptedQuiz.answers[Number(index)] === 'three' ? 'right__label' : ''}
                                        ${attemptedQuiz.attempts[Number(index)] !== attemptedQuiz.answers[Number(index)]
                                                && attemptedQuiz.attempts[Number(index)] === 'three' ? 'wrong__label' : ''}`}>
